/****************************************************************************************
 *  All rights reserved.
 *  Delimited VI name: IX5_MLB.vi
 *  Generated from: E:\Design Documents\LV Files\STM32\IX5 Software\IX5_MLB.vi
 *  Generated UI: false
...
struct _IX5_MLB_heap { 
    ...
    VoidHand Args6AB_1;  
    VoidHand Args697_1;  
    VoidHand s_IO_Open_Test_VI_vi_FailCode;
    ...
    uInt8 by_IO_Open_Test_VI_vi_err_out;
    uInt8 runStat697;  
    uInt8 runStat6AB;  
    uInt8 runStatB4;  
    uInt8 runStat46A_1;  
...
} _DATA_SECTION __IX5_MLB_heap; /* heap */

static struct _IX5_MLB_heap _DATA_SECTION *heap = &__IX5_MLB_heap; /* heap */

static uInt32 _DATA_SECTION _IX5_MLB_signalsReadyTable[39];

struct _tIX5_MLB_GlobalConstantsHeap {
    uInt8   refCnt;
    VoidHand    iF5A;
} _DATA_SECTION __IX5_MLB_GlobalConstantsHeap;
static struct _tIX5_MLB_GlobalConstantsHeap _DATA_SECTION *IX5_MLB_GlobalConstantsHeapPtr = &__IX5_MLB_GlobalConstantsHeap;

struct _tIX5_MLB_viInstanceHeap {
    Boolean initialized;
    subVIInstanceData   i25D;
    subVIInstanceData   i290;
    subVIInstanceData   i2C3;
    subVIInstanceData   i65C;
    subVIInstanceData   i697;
...
} _DATA_SECTION __IX5_MLB_viInstanceHeap;
static struct _tIX5_MLB_viInstanceHeap _DATA_SECTION *IX5_MLB_viInstanceHeapPtr = &__IX5_MLB_viInstanceHeap;

static StepArray _DATA_SECTION stepArr = NULL;
static uInt32 _DATA_SECTION *signalsReady = (uInt32 *) _IX5_MLB_signalsReadyTable; /* heap */
...
#define gArrControlData IX5_MLB_gArrControlData
ControlDataItem _DATA_SECTION IX5_MLB_gArrControlData[1] = {
...
Boolean _TEXT_SECTION IX5_MLB_InitFPTerms(ArgList *argsIn, Boolean bShowFrontPanel);
Boolean _TEXT_SECTION IX5_MLB_InitFPTerms(ArgList *argsIn, Boolean bShowFrontPanel){
    return true;
}
#define IX5_MLB_FrontPanelInit NULL
#define IX5_MLB_DrawLabels NULL
...
void _TEXT_SECTION IX5_MLB_Cleanup(Boolean bShowFrontPanel);
void _TEXT_SECTION IX5_MLB_Cleanup(Boolean bShowFrontPanel){
...
Boolean _TEXT_SECTION IX5_MLB_GetFPTerms( ArgList *argsOut );
Boolean _TEXT_SECTION IX5_MLB_GetFPTerms( ArgList *argsOut ){
    if (!argsOut) {
        return true;
    }
...
void _TEXT_SECTION IX5_MLB_CleanupLSRs(void);
void _TEXT_SECTION IX5_MLB_CleanupLSRs(void) {
}
...
void _TEXT_SECTION IX5_MLB_AddSubVIInstanceData(void);
void _TEXT_SECTION IX5_MLB_AddSubVIInstanceData(void) {
    if (IX5_MLB_viInstanceHeapPtr->initialized) return;
    IX5_MLB_viInstanceHeapPtr->initialized = TRUE;

    IX5_MLB_viInstanceHeapPtr->i25D.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->i25D;
    IX5_MLB_viInstanceHeapPtr->i290.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->i290;
    IX5_MLB_viInstanceHeapPtr->i2C3.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->i2C3;
    IX5_MLB_viInstanceHeapPtr->i65C.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->i65C;
    IX5_MLB_viInstanceHeapPtr->i697.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->i697;
    IX5_MLB_viInstanceHeapPtr->i6AB.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->i6AB;
    IX5_MLB_viInstanceHeapPtr->i879.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->i879;
    IX5_MLB_viInstanceHeapPtr->i8D4.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->i8D4;
    IX5_MLB_viInstanceHeapPtr->i92E.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->i92E;
    IX5_MLB_viInstanceHeapPtr->i964.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->i964;
    IX5_MLB_viInstanceHeapPtr->i9A1.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->i9A1;
    IX5_MLB_viInstanceHeapPtr->iA0E.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->iA0E;
    IX5_MLB_viInstanceHeapPtr->iA66.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->iA66;
    IX5_MLB_viInstanceHeapPtr->iBD0.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->iBD0;
    IX5_MLB_viInstanceHeapPtr->iC18.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->iC18;
    IX5_MLB_viInstanceHeapPtr->iC60.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->iC60;
    IX5_MLB_viInstanceHeapPtr->iE33.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->iE33;
    IX5_MLB_viInstanceHeapPtr->iE7B.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->iE7B;
    IX5_MLB_viInstanceHeapPtr->iE80.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->iE80;
    IX5_MLB_viInstanceHeapPtr->iEC3.next = gVIInstanceListHead;
    gVIInstanceListHead = &IX5_MLB_viInstanceHeapPtr->iEC3;
}
...
void _TEXT_SECTION IX5_MLB_AddVIGlobalConstants(void);
void _TEXT_SECTION IX5_MLB_AddVIGlobalConstants(void) {
    MemSet(IX5_MLB_GlobalConstantsHeapPtr,sizeof(*(IX5_MLB_GlobalConstantsHeapPtr)),0);
}
...
void _TEXT_SECTION IX5_MLB_CleanupVIGlobalConstants(void);
void _TEXT_SECTION IX5_MLB_CleanupVIGlobalConstants(void) {
    (IX5_MLB_GlobalConstantsHeapPtr->refCnt)--;
}
...
void _TEXT_SECTION IX5_MLB_InitVIConstantList(void);
void _TEXT_SECTION IX5_MLB_InitVIConstantList(void) {
    (IX5_MLB_GlobalConstantsHeapPtr->refCnt)++;
}
...
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_924(Boolean bRunToFinish);
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_924(Boolean bRunToFinish) {
...
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_7DA(Boolean bRunToFinish);
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_7DA(Boolean bRunToFinish) {
    eRunStatus runStat = eReady;
    int16 nReady = 0;
    int16 nDispatched = 0;
...
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_804(Boolean bRunToFinish);
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_804(Boolean bRunToFinish) {
    eRunStatus runStat = eReady;
    int16 nReady = 0;
    int16 nDispatched = 0;
...
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_6DE(Boolean bRunToFinish);
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_6DE(Boolean bRunToFinish) {
    eRunStatus runStat = eReady;
    int16 nReady = 0;
    int16 nDispatched = 0;
...
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_6B7(Boolean bRunToFinish);
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_6B7(Boolean bRunToFinish) {
    eRunStatus runStat = eReady;
    int16 nReady = 0;
    int16 nDispatched = 0;
...
/* start q el struct (0 or 1 struct)*/
                case 1 : {
                    heap->runStat804 = IX5_MLB_RunFunc_804( bRunToFinish  );
...
/* start q el struct (0 or 1 struct)*/
                case 1 : {
                    heap->runStat6DE = IX5_MLB_RunFunc_6DE( bRunToFinish  );
...
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_35F(Boolean bRunToFinish);
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_35F(Boolean bRunToFinish) {
    eRunStatus runStat = eReady;
    int16 nReady = 0;
    int16 nDispatched = 0;
...
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_5A2(Boolean bRunToFinish);
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_5A2(Boolean bRunToFinish) {
    eRunStatus runStat = eReady;
    int16 nReady = 0;
    int16 nDispatched = 0;
...
/* start q el linear (0 or 1 struct) */
                case 0 : {
                    ...
                    IX5_MLB_GlobalConstantsHeapPtr->iF5A = PDAStrNewFromBuf(_LVT("Rev:1.0.1 MLB_L (03112017);Powered by KSHJT;"),(uInt32)44);
                    heap->s_String = IX5_MLB_GlobalConstantsHeapPtr->iF5A;
                    nStep++;}
/* start q el struct (0 or 1 struct)*/
                case 1 : {
                    ...
                    }
                    {
                        ...
                        if (!IX5_MLB_viInstanceHeapPtr->iE80.callerID) {
                            IX5_MLB_viInstanceHeapPtr->iE80.callerID = ++gCallerID;
                        }
                        heap->runStatE80 = UploadStatus_Run( &IX5_MLB_viInstanceHeapPtr->iE80, false, (Boolean)(bRunToFinish && (nReady < 2)), (ArgList *)((ArgList **)heap->ArgsE80_1)[0], (ArgList *)((ArgList **)heap->ArgsE80_1)[1], NULL );
...
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_B4(Boolean bRunToFinish);
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_B4(Boolean bRunToFinish) {
    eRunStatus runStat = eReady;
    int16 nReady = 0;
    int16 nDispatched = 0;
...
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_6C(Boolean bRunToFinish);
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_6C(Boolean bRunToFinish) {
    eRunStatus runStat = eReady;
    int16 nReady = 0;
    int16 nDispatched = 0;
                                ...
                                if (GetSignalReady( 29 )) {
                                    if (pass) {
                                        ...
                                        }
                                        {
                                            ...
                                            if (!IX5_MLB_viInstanceHeapPtr->i290.callerID) {
                                                IX5_MLB_viInstanceHeapPtr->i290.callerID = ++gCallerID;
                                            }
                                            heap->runStat290 = VISA_Serial_Read_Run( &IX5_MLB_viInstanceHeapPtr->i290, false, (Boolean)(bRunToFinish && (nReady < 2)), (ArgList *)((ArgList **)heap->Args290_1)[0], (ArgList *)((ArgList **)heap->Args290_1)[1], NULL );
                                            LVSetCurrentControlData(cdPtr);
...
/* start q el struct (2 struct) */
                            if (heap->runStat5A2 != eFinished) {
                                ...
                                if (GetSignalReady( 28 )) {
                                    if (pass) {
                                        heap->runStat5A2 = IX5_MLB_RunFunc_5A2( (Boolean)(bRunToFinish && (nReady < 2)) );
...
/* start q el struct (0 or 1 struct)*/
                    case 1 : {
                        heap->runStat35F = IX5_MLB_RunFunc_35F( bRunToFinish  );
...
/* start q el linear (2 struct) */
                            if (heap->runStat46A_1 != eFinished) {
                                ...
                                if (pass == 0) {
                                    ...
                                    /*InitSignalReady( 0x2, 7);*//* s_IO_Open_Test_VI_vi_FailCode */
                                    /*InitSignalReady( 0x16, 5);*//* e_VISA_resource_name_2 */
                                    /*InitSignalReady( 0xE, 1);*//* by_IO_Open_Test_VI_vi_err_out */
                                    InitSignalReady(18, 2);
                                    /*InitSignalReady( 0x19, 5);*//* b_IO_Open_Test_VI_vi_pass_ */
...
/* start q el struct (2 struct) */
                            if (heap->runStat697 != eFinished) {
                                if (pass == 0) {
                                    nReady++;
                                }
                                if (pass) {
                                    if (heap->runStat697 == eReady) {
                                    }
                                    {
                                        ControlDataItemPtr cdPtr = LVGetCurrentControlData();
                                        if (heap->runStat697 == eReady) {
                                            CreateArgListStatic(heap->Args697_1, 1, 3 );
                                            argIn(heap->Args697_1, 0).nType = 0;
                                            argIn(heap->Args697_1, 0).pValue = NULL;
                                            argOut(heap->Args697_1, 0).nType = uCharDataType;
                                            argOut(heap->Args697_1, 0).pValue = (void *)&heap->by_IO_Open_Test_VI_vi_err_out;
                                            argOut(heap->Args697_1, 1).nType = StringDataType;
                                            argOut(heap->Args697_1, 1).pValue = (void *)&heap->s_IO_Open_Test_VI_vi_FailCode;
                                            argOut(heap->Args697_1, 2).nType = BooleanDataType;
                                            argOut(heap->Args697_1, 2).pValue = (void *)&heap->b_Case_Structure_CT;
                                        }
                                        if (!IX5_MLB_viInstanceHeapPtr->i697.callerID) {
                                            IX5_MLB_viInstanceHeapPtr->i697.callerID = ++gCallerID;
                                        }
                                        heap->runStat697 = IO_Open_Test_VI_Run( &IX5_MLB_viInstanceHeapPtr->i697, false, (Boolean)(bRunToFinish && (nReady < 2)), (ArgList *)((ArgList **)heap->Args697_1)[0], (ArgList *)((ArgList **)heap->Args697_1)[1], NULL );
                                        LVSetCurrentControlData(cdPtr);
                                        if (heap->runStat697 == eNotFinished || heap->runStat697 == eDispatched) {
                                            runStat = heap->runStat697;
                                        }
                                        if (heap->runStat697 == eFail || gLastError) {
                                            CGenErr();
                                        }
                                        if (gAppStop || (heap->runStat697 == eFinished)) {
                                            /*SetSignalReady( 0xE, 1);*//* by_IO_Open_Test_VI_vi_err_out */
                                            SetSignalReady(19, 1);
                                            /*SetSignalReady( 0x2, 7);*//* s_IO_Open_Test_VI_vi_FailCode */
                                            SetSignalReady(19, 1);
                                            /*SetSignalReady( 0x19, 5);*//* b_IO_Open_Test_VI_vi_pass_ */
                                            SetSignalReady(18, 1);
                                        }
                                        if (gAppStop) {
                                            gAppStop=true;
                                    ...
                                    if (pass) {
                                        ...
                                        }
                                        {
                                            ...
                                            if (heap->runStat6AB == eReady) {
                                                ...
                                                argIn(heap->Args6AB_1, 0).pValue = (void *)&heap->by_IO_Open_Test_VI_vi_err_out;
                                                argIn(heap->Args6AB_1, 1).nType = StringDataType;
                                                argIn(heap->Args6AB_1, 1).pValue = (void *)&heap->s_IO_Open_Test_VI_vi_FailCode;
                                            ...
                                            if (!IX5_MLB_viInstanceHeapPtr->i6AB.callerID) {
                                                IX5_MLB_viInstanceHeapPtr->i6AB.callerID = ++gCallerID;
                                            }
                                            heap->runStat6AB = UploadStatus_Run( &IX5_MLB_viInstanceHeapPtr->i6AB, false, (Boolean)(bRunToFinish && (nReady < 2)), (ArgList *)((ArgList **)heap->Args6AB_1)[0], (ArgList *)((ArgList **)heap->Args6AB_1)[1], NULL );
                                            LVSetCurrentControlData(cdPtr);
...
/* start q el struct (0 or 1 struct)*/
                    case 1 : {
                        heap->runStat6B7 = IX5_MLB_RunFunc_6B7( bRunToFinish  );
                                ...
                                if (GetSignalReady( 7 )) {
                                    if (pass) {
                                        ...
                                        }
                                        {
                                            ...
                                            if (!IX5_MLB_viInstanceHeapPtr->i65C.callerID) {
                                                IX5_MLB_viInstanceHeapPtr->i65C.callerID = ++gCallerID;
                                            }
                                            heap->runStat65C = UploadResult_Run( &IX5_MLB_viInstanceHeapPtr->i65C, false, (Boolean)(bRunToFinish && (nReady < 2)), (ArgList *)((ArgList **)heap->Args65C_1)[0], (ArgList *)((ArgList **)heap->Args65C_1)[1], NULL );
                                            LVSetCurrentControlData(cdPtr);
...
/* start q el struct (2 struct) */
                            if (heap->runStat7DA != eFinished) {
                                ...
                                if (GetSignalReady( 6 )) {
                                    if (pass) {
                                        heap->runStat7DA = IX5_MLB_RunFunc_7DA( (Boolean)(bRunToFinish && (nReady < 2)) );
...
/* start q el struct (2 struct) */
                            if (heap->runStat924 != eFinished) {
                                ...
                                if (GetSignalReady( 4 )) {
                                    if (pass) {
                                        heap->runStat924 = IX5_MLB_RunFunc_924( (Boolean)(bRunToFinish && (nReady < 2)) );
...
/* start q el struct (0 or 1 struct)*/
                    case 1 : {
                        heap->runStatB4 = IX5_MLB_RunFunc_B4( bRunToFinish  );
...
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_31(Boolean bRunToFinish);
eRunStatus _TEXT_SECTION IX5_MLB_RunFunc_31(Boolean bRunToFinish) {
    eRunStatus runStat = eReady;
    int16 nReady = 0;
    int16 nDispatched = 0;
...
/* start q el struct (2 struct) */
                    if (heap->runStat6C != eFinished) {
                        ...
                        if (GetSignalReady( 37 )) {
                            if (pass) {
                                heap->runStat6C = IX5_MLB_RunFunc_6C( (Boolean)(bRunToFinish && (nReady < 2)) );
...
eRunStatus _TEXT_SECTION IX5_MLB_BlockDiagram(Boolean bProcessFrontPanel, Boolean bRunToFinish);
eRunStatus _TEXT_SECTION IX5_MLB_BlockDiagram(Boolean bProcessFrontPanel, Boolean bRunToFinish){
    eRunStatus runStat = eReady;
    int16 nReady = 1;
    int16 nDispatched = 0;
...
/* start q el struct (0 or 1 struct)*/
        case 1 : {
            heap->runStat31 = IX5_MLB_RunFunc_31( bRunToFinish  );
    ...
    IX5_MLB_CleanupVIGlobalConstants();
    return eFinished;
}

/****** VI Configuration data **********/

TextPtr IX5_MLB_VIName = "IX5_MLB.vi";
...
static VIInfo _DATA_SECTION viInfo = {
    ...
    gFormID,
    (uInt8 **)&heap,
    (uInt32)sizeof (struct _IX5_MLB_heap),
    &signalsReady,
    ...
    false,
    (uInt8**)&stepArr,
    (uInt8**) &IX5_MLB_viInstanceHeapPtr,
    (uInt32)sizeof (struct _tIX5_MLB_viInstanceHeap),
    IX5_MLB_InitFPTerms,
    IX5_MLB_FrontPanelInit,
    IX5_MLB_BlockDiagram,
    IX5_MLB_DrawLabels,
    IX5_MLB_GetFPTerms,
    IX5_MLB_Cleanup,
    IX5_MLB_CleanupLSRs,
    IX5_MLB_AddSubVIInstanceData,
    IX5_MLB_InitVIConstantList
};

/****** Main Entry Point for VI **********/

eRunStatus _TEXT_SECTION IX5_MLB_Run(subVIInstanceDataPtr viInstanceData, Boolean bShowFrontPanel, Boolean bRunToFinish, ArgList* argsIn, ArgList* argsOut, Boolean *pause){
